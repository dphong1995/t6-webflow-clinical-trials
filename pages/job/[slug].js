      ...
      <div data-collapse="medium" data-animation="over-left" data-duration={400}
        ...
        <div className="container-default w-container">
          <div className="header-wrapper">
            <div className="split-content header-right"><a href="/" className="brand w-nav-brand" aria-label="home"><img
            ...
            <div className="split-content header-center">
              <nav role="navigation" className="nav-menu w-nav-menu">
                <ul role="list" className="header-navigation">
                  <li className="nav-item-wrapper"><a href="/" className="nav-link">Home</a></li>
                          ...
                          <div className="dropdown-nav-pages-wrapper">
                            ...
                            <div className="dropdown-nav-content">
                              <ul role="list" className="dropdown-nav">
                                <li className="dropdown-nav-item"><a href="/" className="dropdown-nav-link"
...
" data-wf-page-link-href-prefix className="w-commerce-commercecartwrapper cart"><a href="#"
            ...
            <div data-w-id="5086ac48-b95c-42a9-0a58-6e690b1c648f" style={{
              ...
              <div className="card job-post">
                <div data-w-id="ebcc2b89-9ed8-8b91-2d0e-6dfaa089b244" className="image-wrapper card-job-post"><img
                  src="https://uploads-ssl.webflow.com/637be9fff1765c82ee8ddd63/637be9fff1765c694a8dde56_image-8-cover-company-job-board-x-template.jpg"
                  alt="Webflow"
                  sizes="(max-width: 767px) 93vw, (max-width: 991px) 95vw, (max-width: 1439px) 74vw, 847px"
                  srcSet="https://uploads-ssl.webflow.com/637be9fff1765c82ee8ddd63/637be9fff1765c694a8dde56_image-8-cover-company-job-board-x-template-p-500.jpeg 500w, https://uploads-ssl.webflow.com/637be9fff1765c82ee8ddd63/637be9fff1765c694a8dde56_image-8-cover-company-job-board-x-template-p-800.jpeg 800w, https://uploads-ssl.webflow.com/637be9fff1765c82ee8ddd63/637be9fff1765c694a8dde56_image-8-cover-company-job-board-x-template.jpg 1964w"
                  className="image card-job-post" style={{
                  willChange: 'transform',
                  transform: 'translate3d(0px, -4.4923px, 0px) scale3d(1.02246, 1.02246, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
                  transformStyle: 'preserve-3d'
                }}/></div>
                <div className="card-job-post-content">
                  <div className="card-job-post-content-top">
                    <div className="card-job-post-title-wrapper">
                      <div className="image-wrapper card-job-post-logo"><img
                        ...
                        alt="Backend Software Engineer" className="image card-job-post-logo"/></div>
                      <h1 className="title h2-size card-job-post">Heading</h1></div>
                    <div className="card-job-post-categories-wrapper">
                      ...
                      <div className="card-job-post-category-wrapper">
                        <div className="card-job-post-category-title-wrapper"><img
                          src="https://uploads-ssl.webflow.com/637be9fef1765c0f958ddd3c/637be9fff1765c5f978ddd90_icon-5-job-categories-job-board-x-template.svg"
                  ...
                  <div className="card-job-post-content-bottom">
                    ...
                    <div className="w-richtext"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tellus augue
                      sagittis erat consectetur est. Blandit blandit nec <a href="#">mauris pulvinar</a>. Lectus duis
                      amet tortor, sit tincidunt. Rhoncus tincidunt imperdiet penatibus vitae risus, vitae. <strong>Blandit
                        auctor</strong> justo nisl massa.</p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Lectus dictum ultrices lacus sodales nunc felis eu, consectetur arcu. Vitae nulla scelerisque id
                      pellentesque feugiat vel eu.</p></div>
                    <h2 className="title h3-size job-rich-text">Inclusion Criteria</h2>
                    <div className="w-richtext"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lectus
                      dictum ultrices lacus sodales nunc felis eu, consectetur arcu. Vitae nulla scelerisque id
                ...
                <div className="card job-post-sidebar last">
                  ...
                  <div className="card-job-post-sidebar-content">
                    <div className="card-job-post-sidebar-title-about-company-wrapper"><h3
                      ...
                      className="title h4-size card-job-post-sidebar-about-company">Webflow</h3></div>
                    <p className="paragraph card-job-post-sidebar">Lorem ipsum dolor sit amet, consectetur adipiscing
                      elit. Sed turpis sit aliquam faucibus fringilla eu.</p><a href="/company/webflow"
              ...
              <div data-w-id="56137bc8-507d-e022-9903-33a938c5d594" style={{
                ...
                <div className="split-content content-top-more-jobs-left"><h2 className="title more-jobs">More job
                  openings</h2></div>
                  ...
                  <div role="listitem" className="job-item w-dyn-item"><a href="/job/digital-marketing-specialist"
                    ...
                    <div className="split-content card-job-left">
                      <div className="image-wrapper card-job"><img
                        src="https://uploads-ssl.webflow.com/637be9fff1765c82ee8ddd63/637be9fff1765c26cc8dde55_icon-8-company-job-board-x-template.svg"
                        alt="Digital Marketing Specialist" className="image card-job"/></div>
                      <div className="card-job-title-wrapper"><h3 className="title h6-size card-job">Digital Marketing
                        Specialist</h3>
            ...
            <div data-w-id="303e2183-3b6a-8bf1-f737-049bfd79a52e" style={{
              ...
              <div className="job-post-sidebar-wrapper">
                ...
                <div className="card job-post-sidebar last">
                  <div className="image-wrapper card-job-post-sidebar-icon"><img
                    src="https://uploads-ssl.webflow.com/637be9fff1765c82ee8ddd63/637be9fff1765c26cc8dde55_icon-8-company-job-board-x-template.svg"
                    alt="Webflow" className="image card-job-post-sidebar-icon"/></div>
                  <div className="card-job-post-sidebar-content">
                    <div className="card-job-post-sidebar-title-about-company-wrapper"><h3
                      className="title h4-size card-job-post-sidebar-about-company">About</h3><h3
                      className="title h4-size card-job-post-sidebar-about-company">Webflow</h3></div>
      ...
      <footer className="footer">
        <div className="container-default w-container">
          <div data-w-id="c1f46375-416a-e1fd-79e1-2ba39e96c173" className="footer-content-top" style={{
            opacity: 1,
            transform: 'translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
            transformStyle: 'preserve-3d'
          }}>
            <div className="footer-main-content"><a href="/" className="footer-logo-container w-inline-block"><img
              src="https://uploads-ssl.webflow.com/637be9fef1765c0f958ddd3c/637be9fff1765c40ad8ddde8_job-board-x-logo-webflow-template.svg"
        ...
        <div className="divider footer-content-top-divider"/>
        <div className="container-default w-container">
          <div data-w-id="2d7731e3-3ecf-b08e-09c1-04a83668795d" className="footer-content" style={{
            opacity: 1,
            transform: 'translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
            transformStyle: 'preserve-3d'
          }}>
              ...
              <div className="footer-menu-wrapper">
                ...
                <div className="footer-menu-content">
                  ...
                  <ul role="list" className="footer-nav last w-list-unstyled">
                    <li className="footer-nav-item"><a href="/post-a-job" className="footer-nav-link">Post a free
                      job</a></li>
                ...
                <div className="footer-menu-content">
                  <div className="w-dyn-list">
                    <div role="list" className="footer-nav last w-dyn-items">
                      ...
                      <div role="listitem" className="footer-nav-item w-dyn-item"><a
                        href="/job-level-category/executive" className="footer-nav-link">Executive</a></div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="footer-menu-content">
                  <div className="w-dyn-list">
                    <div role="list" className="footer-nav last w-dyn-items">
                      ...
                      <div role="listitem" className="footer-nav-item w-dyn-item"><a
                        href="/job-location-category/remote" className="footer-nav-link">Remote</a></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container-default w-container">
          <div data-w-id="da3c1876-1f27-b0aa-1431-bb4267681389" className="footer-content-bottom" style={{
            opacity: 1,
            transform: 'translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
            transformStyle: 'preserve-3d'
          }}>
