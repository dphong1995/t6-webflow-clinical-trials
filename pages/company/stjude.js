        ...
        <div className="container-default w-container">
          ...
          <div data-w-id="dd895fd4-7865-6962-cee0-3a705bd5c5dc" style={{
            ...
            <div data-w-id="20db60cc-5039-bf50-045f-0cadf330e220" className="image-wrapper company-cover"><img
              ...
              loading="eager" alt="St. Jude Children's Research Hospital"
              ...
              transform: 'translate3d(0px, -4.1419px, 0px) scale3d(1.02071, 1.02071, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
              transformStyle: 'preserve-3d'
            }}/></div>
            <div className="company-content">
              <div className="content-top company">
                <div className="image-wrapper company"><img
                  ...
                  alt="St. Jude Children's Research Hospital" className="image company"/></div>
                <div className="company-content-top-wrapper">
                  <div className="split-content content-top-company-left"><h1 className="title h2-size company">St. Jude
                    Children's Research Hospital</h1>
                  ...
                  <div className="split-content content-top-company-right"><a
                    data-w-id="18e4c4a1-e2a5-df93-57f4-c9a8d529c360" href="https://www.stjude.org/" target="_blank"
                    ...
                    <div className="w-dyn-list">
                      <div role="list" className="jobs-grid w-dyn-items">
                        <div role="listitem" className="job-item w-dyn-item"><a
                          href="/job/study-of-cd19-directed-allogeneic-memory-t-cell-therapy"
                          ...
                          <div className="split-content card-job-left">
                            ...
                            <div className="card-job-title-wrapper"><h3 className="title h6-size card-job">Study of
                    ...
                    <div className="company-about-wrapper"><h2 className="title h3-size company-about">About the
                      ...
                      <div className="company-about-social-media-bottom-wrapper">
                        <div className="company-about-social-media-text-wrapper">
                          ...
                          <div className="company-about-social-media-text">St. Jude Children's Research Hospital</div>
                        </div>
                        <div className="company-about-social-media-wrapper"><a href="https://www.facebook.com/stjude"
                                                                               target="_blank"
                                                                               className="image-wrapper social-media-link facebook w-inline-block"/><a
                          href="https://twitter.com/StJude" target="_blank"
                          className="image-wrapper social-media-link twitter w-inline-block"/><a
                          href="https://www.instagram.com/stjude/" target="_blank"
                          className="image-wrapper social-media-link instagram w-inline-block"/><a href="#"
                                                                                                   className="image-wrapper social-media-link linkedin w-inline-block w-condition-invisible"/><a
                          href="https://www.youtube.com/user/MyStJude" target="_blank"
